  ...
  return (
    <>
      <Helmet>
        ...
        <title>Herren Friseur SAFFET Berlin | Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Herren Friseur SAFFET in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Herren Friseur SAFFET | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Herren Friseur SAFFET | Premium Barbershop Berlin" />
        <meta
